...
<div id="values" class="sub">
	...
	<section class="subpage" id="leadership">

		<div class="inner">
		
			<h2>Our Team</h2>

			<h3>Board of Directors and Leadership Team</h3>
			...
			<article class="item">
				...
				<div class="text">
					...
					<h6>Charles Barrett Attorney at Law</h6>
			...
			<article class="item">
				...
				<div class="text">
					...
					<h4>Chris Cigarran</h4>

					<h5>Elected 2012</h5>

					<h6>Senior Advisor, Healthways</h6>
			...
			<article class="item">
				...
				<div class="text">
					...
					<h6>President, Southwestern Investment Services, Inc.</h6>
			...
			<article class="item">
				...
				<div class="text">
					...
					<h6>Special Assistant to the Mayor</h6>
